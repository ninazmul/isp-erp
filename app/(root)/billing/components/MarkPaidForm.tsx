                ...
                <div className="max-h-[58vh] overflow-y-auto space-y-4 pr-1 pb-4">
                    ...
                    <div className="rounded-2xl border border-slate-100 bg-slate-50/80 overflow-hidden">
                        ...
                        <div className="grid grid-cols-2 gap-3 px-4 pb-3">
                            <div
                                className={`rounded-xl border p-3.5 transition-colors ${afterPaymentDue > 0
                                        ? "border-amber-200 bg-amber-50"
                                        : "border-emerald-200 bg-emerald-50"
                                    }`}
                            >
                                <p
                                    className={`text-[10px] font-black uppercase tracking-wider mb-1 ${afterPaymentDue > 0 ? "text-amber-600" : "text-emerald-600"
                                        }`}
                                >
                                    Due
                                </p>
                            ...
                            <div
                                className={`rounded-xl border p-3.5 transition-colors ${afterPaymentAdvance > 0
                                        ? "border-cyan-200 bg-cyan-50"
                                        : "border-slate-200 bg-slate-100/60"
                                    }`}
                            >
                                <p
                                    className={`text-[10px] font-black uppercase tracking-wider mb-1 ${afterPaymentAdvance > 0 ? "text-cyan-600" : "text-slate-400"
                                        }`}
                                >
                                    Advance
                                </p>
                        ...
                        <div
                            className={`flex items-center justify-between px-4 py-3 border-t ${isFullyPaid ? "border-emerald-100 bg-emerald-50/50" : "border-slate-100 bg-white"
                                }`}
                        >
